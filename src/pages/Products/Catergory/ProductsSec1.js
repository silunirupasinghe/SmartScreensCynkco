    ...
    <Box
      sx={{
        ...
        "&:before": {
          ...
          backgroundSize: { xs: "20px 20px", md: "30px 30px" }, // Smaller pattern on mobile
          opacity: 0.2,
          zIndex: 2,
        },
      }}
      ...
      >
        <Box
          sx={{
            ...
            textAlign: "center",
            minHeight: { xs: "40vh", sm: "50vh", md: "60vh" }, // Adjusted height for mobile
          }}
        >
          {/* Text Section */}
          <Fade in timeout={{ enter: 1000, exit: 500 }}>
            <Box sx={{ maxWidth: { xs: "100%", sm: "600px", md: "800px" } }}>
              ...
              >
                Discover Cynkco's cutting-edge products designed to enhance
                security, collaboration, and growth.
              </Typography>
            </Box>
          </Fade>
        </Box>
