...
import CTSC85A_stand from "../../../Assets/Products/Screens/CTSC85A/CTSC85A-stand.jpg";
import CTSC85A_side from "../../../Assets/Products/Screens/CTSC85A/CTSC85A-side.jpg";
...
const CTSC85APage = () => {
  ...
  const images = [
    ...
    { src: CTSC85A_stand, alt: "CYNKCO Smart Screen CT-SC85A Alternate" },
    { src: CTSC85A_side, alt: "CYNKCO Smart Screen CT-SC85A Side View" },
  ];
  ...
  useEffect(() => {
    ...
    if (formStatus.submitted) {
      const timer = setTimeout(() => {
        ...
        link.href = "/path/to/CT-SC85A_brochure.pdf"; // Update with real path
        link.download = "CT-SC85A_brochure.pdf";
  ...
  const specsData = [
    ...
    },
    {
      label: "Power",
      value:
        "360W max, ≤0.5W standby, 100-240V ~ 50/60Hz 5.5A, power connector at bottom",
    },
    {
      label: "Dimensions & Weight",
      value:
        "1953.5 x 1154 x 88.4 mm (machine size), 110.4 mm thickness (without wall plate), 2116 x 267 x 1395 mm (package size), 800 x 400 mm VESA, M8 x 25 mm wall mounting screws, 68 kg net weight, 83 kg gross weight",
    },
    {
      label: "Accessories",
      value:
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                  ...
                  >
                    ...
                    <input
                      type="hidden"
                      name="_subject"
                      value="New Brochure Download Request - CT-SC85A"
                    />
                    <input
                      type="hidden"
                      name="_autoresponse"
                      value="Thank you for downloading the CT-SC85A brochure!"
                    />
